...
class CityAdapter(object):
    ...
    def _configuration_to_entity_city_by_id(cls, configuration: Dict) -> City:
        configuration_entity = City(
            ...
            distanceMetricsUnit=configuration.get("distanceMetricsUnit") or 0,
            radiusforsomeOneElseBooking=configuration.get("radiusforsomeOneElseBooking") or 0,
            maxEtaDistanceInMeters=configuration.get("maxEtaDistanceInMeters") or 0,
            maxEtaTimeInSeconds=configuration.get("maxEtaTimeInSeconds") or 0,
            isTipEnable=configuration.get("isTipEnable") or "",
            tipType=configuration.get("tipType") or 0,
